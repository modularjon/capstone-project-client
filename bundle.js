...
/***/ function(module, exports, __webpack_require__) {
	...
	var drawGridRects = function drawGridRects(gridWidth, gridHeight, canvasSize) {
	  ...
	  for (var i = 0; i < gridWidth; i++) {
	    for (var j = 0; j < gridHeight; j++) {
	      var paperPixel = new paper.Path.Circle(canvasSize.left + (i + 0.5) * widthPixels, canvasSize.top + (j + 0.5) * heightPixels, widthPixels / 2);
	...
	var onClearDrawing = function onClearDrawing(event) {
	  event.preventDefault();
